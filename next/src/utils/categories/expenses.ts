...
export const expenses = new CategoryRegistry(
    new Category({
        names: ["Expenses"],
        children: [
            new Category({
            ...
            new Category({
                ...
                children: [
                    ...
                    new Category({ names: ["Books, audio, subscriptions"] }),
                    new Category({
                        names: ["Charity, gifts"],
            ...
            new Category({
                ...
                children: [
                    ...
                    new Category({
                        ...
                        children: [
                            new Category({ names: ["Phone, cell phone"] }),
                        ],
                    }),
                ],
            }),
            ...
            new Category({
                ...
                children: [
                    ...
                    new Category({
                        ...
                        children: [
                            new Category({ names: ["Loan, interests"] }),
                        ],
                    }),
                    new Category({
                        names: ["Taxes"],
